...
let path = {
	...
	build: {
		...
		/* путь к папке с дополнениями libs */
...
let { src, dest } = require('gulp'),
	...
	/* переменная для дополнения gulp-stylelint */
	gulpStylelint = require('gulp-stylelint');

// /* переменная для дополнения gulp-htmlmin */
...
let build = gulp.series(clean, gulp.parallel(js, css, html, images, fonts, coppyCss, coppyDir, lintCss), fontsStyle);
